...
Public Class GreyPurchaseOrderDetails
    ...
    Private Sub GreyPurchaseOrderDetails_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
    ...
    Sub fillgrid()
        Try
            Dim OBJPO As New ClsGreyPurchaseOrder
    ...
    Sub SERVERPROPDIRECT(Optional ByVal INVOICEMAIL As Boolean = False, Optional ByVal WHATSAPP As Boolean = False)
        Try
            ...
            For I As Integer = Val(TXTFROM.Text.Trim) To Val(TXTTO.Text.Trim)
                ...
                OBJPO.FORMULA = "{GREYPURCHASEORDER.PO_NO}=" & Val(I) & " and {GREYPURCHASEORDER.PO_yearid}=" & YearId
                OBJPO.PONO = Val(I)
    ...
    Sub SERVERPROPSELECTED(Optional ByVal INVOICEMAIL As Boolean = False, Optional ByVal WHATSAPP As Boolean = False)
        Try
            ...
            For I As Integer = 0 To Val(SELECTEDROWS.Length - 1)
                ...
                OBJPO.DIRECTWHATSAPP = WHATSAPP
                OBJPO.PRINTSETTING = PRINTDIALOG
                OBJPO.FORMULA = "{GREYPURCHASEORDER.PO_NO}=" & Val(ROW("PONO")) & " and {GREYPURCHASEORDER.PO_yearid}=" & YearId
