...
Public Class OpeningPurchaseOrder
    ...
    Private Sub OPENINGPURCHASEORDER_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Private Sub OPENINGPURCHASEORDER_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
...
LINE1:
    ...
    Sub total()
        ...
        For Each row As DataGridViewRow In GRIDPO.Rows
            ...
            If Val(row.Cells(grate.Index).EditedFormattedValue) <> 0 Then row.Cells(gamt.Index).Value = Format(Val(row.Cells(grate.Index).EditedFormattedValue) * Val(row.Cells(grate.Index).EditedFormattedValue), "0.00")
    ...
    Private Sub gridOPO_CellDoubleClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles GRIDPO.CellDoubleClick
    ...
    Private Sub gridOPO_CellValidating(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellValidatingEventArgs) Handles GRIDPO.CellValidating
    ...
    Private Sub gridOPO_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles GRIDPO.KeyDown
    ...
    Private Sub tstxtbillno_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles tstxtbillno.Validating
        Try
            If Val(tstxtbillno.Text.Trim) > 0 Then
                ...
                If tempono > 0 Then
                    EDIT = True
                    OPENINGPURCHASEORDER_Load(sender, e)
                Else
                    CLEAR()
                    EDIT = False
                End If
    ...
    Sub PRINTREPORT()
        Try
            ...
            'OBJPO.FORMULA = "{OPENINGPURCHASEORDER.OPO_NO}=" & Val(TXTPONO.Text) & " and {OPENINGPURCHASEORDER.OPO_yearid}=" & YearId
            OBJPO.Show()
        Catch ex As Exception
            Throw ex
        End Try
...
LINE1:
    ...
    Private Sub OpenToolStripButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OpenToolStripButton.Click
        Try
            ...
            Dim objpodtls As New OpeningPurchaseOrderDetails
    ...
    Sub GETCONSUMPTION(ITEMNAME As String)
        Try
            ...
            Dim TEMPDATE As Date = (Convert.ToDateTime(PODATE.Text).Date.AddMonths(-1))
            ...
            TEMPDATE = (Convert.ToDateTime(PODATE.Text).Date.AddMonths(-3))
    ...
    Private Sub GRIDOPO_RowEnter(sender As Object, e As DataGridViewCellEventArgs) Handles GRIDPO.RowEnter
        Try
