...
Public Class OpeningSaleOrder
    ...
    Sub GETMAX_SO_NO()
        Dim DTTABLE As DataTable = getmax(" isnull(max(OSO_no),0) + 1 ", "OPENINGSALEORDER", " and OSO_yearid=" & YearId)
    ...
    Private Sub OPENINGSALEORDER_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            If EDIT = True Then
                ...
                Dim DT As DataTable = OBJSO.SELECTOPSO(TEMPSONO, CmpId, Locationid, YearId)
                ...
                If DT.Rows.Count > 0 Then
                    For Each DR As DataRow In DT.Rows
                        ...
                        GRIDSO.Rows.Add(Val(DR("GRIDSRNO")), DR("ITEMNAME"), DR("DESIGNNO"), DR("COLOR"), Val(DR("BALES")), Format(Val(DR("RATE")), "0.00"), Format(Val(DR("AMT")), "0.00"), DR("GRIDREMARKS"), DR("CLOSED"), Val(DR("OUTBALES")))
    ...
    Sub GETSTOCK(ByVal MERCHANTNAME As String)
        Try
            If MERCHANTNAME <> "" Then
                ...
                Dim DT As DataTable = OBJCMN.search(" COUNT(DISTINCT BALENO) AS TOTALBALES, ISNULL(SUM(PCS),0) AS TOTALPCS, ISNULL(SUM(MTRS),0) AS TOTALMTRS ", "", " BALESTOCK_VIEW ", " AND MERCHANT = '" & MERCHANTNAME & "' AND CHALLANNO = 0 AND CMPID = " & CmpId & " AND LOCATIONID = " & Locationid & " AND YEARID = " & YearId)
                If DT.Rows.Count > 0 Then
    ...
    Sub FILLGRID()
        ...
        If GRIDDOUBLECLICK = False Then
            GRIDSO.Rows.Add(Val(TXTSRNO.Text.Trim), CMBITEMNAME.Text.Trim, CMBDESIGN.Text.Trim, CMBCOLOR.Text.Trim, Val(TXTBALES.Text.Trim), Format(Val(TXTRATE.Text.Trim), "0.00"), Format(Val(TXTAMOUNT.Text.Trim), "0.00"), TXTGRIDREMARKS.Text.Trim, 0, 0)
            GETSRNO(GRIDSO)
    ...
    Private Sub OpenToolStripButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OpenToolStripButton.Click
        Try
            ...
            Dim OBJSO As New OpeningSaleOrderDetails
