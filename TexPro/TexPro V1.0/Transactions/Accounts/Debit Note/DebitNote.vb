...
Public Class DebitNote
    ...
    Private Sub CMBNAME_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles CMBNAME.Validating
        Try
            If CMBNAME.Text.Trim <> "" Then namevalidate(CMBNAME, e, Me, TXTOTHERCHGSADD, " AND (GROUPMASTER.GROUP_SECONDARY = 'SUNDRY DEBTORS' or GROUPMASTER.GROUP_SECONDARY = 'SUNDRY CREDITORS')", "SUNDRY CREDITORS", "ACCOUNTS", "", CMBAGENT.Text)
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
    ...
    Private Sub CMBCREDITLEDGER_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles CMBCREDITLEDGER.Validating
        Try
            If CMBCREDITLEDGER.Text.Trim <> "" Then namevalidate(CMBCREDITLEDGER, e, Me, TXTOTHERCHGSADD, "", "Purchase A/C")
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
