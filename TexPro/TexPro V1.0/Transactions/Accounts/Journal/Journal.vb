...
Public Class journal
            ...
            If edit = True Then
                ...
                If dt.Rows.Count > 0 Then
                    For Each dr As DataRow In dt.Rows
                        ...
                        If Val(dr("JOURNAL_AMT")) > 0 Then gridjournal.Rows(gridjournal.RowCount - 1).DefaultCellStyle.BackColor = Color.Yellow
    ...
    Private Sub cmbname_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles cmbname.Validating
        Try
            ...
            If cmbname.Text.Trim <> "" Then namevalidate(cmbname, e, Me, TXTADD, " AND GROUPMASTER.GROUP_SECONDARY <> 'Bank A/C' AND GROUPMASTER.GROUP_SECONDARY <> 'Bank OD A/C' AND GROUPMASTER.GROUP_SECONDARY <> 'Cash In Hand'")
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
