...
1:
    ...
    Private Sub Receipt_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        ...
        End If
        If ClientName = "CC" Then txtremarks.Text = TEMPBILLNO
        If ClientName = "MAHAVIR" Or ClientName = "PURVITEX" Then ALLOWMANUALRECNO = True
    End Sub
    ...
    Sub SMSCODE()
        If (ClientName = "MOHAN") And TXTMOBILENO.Text.Trim <> "" Then
            ...
            If DT.Rows.Count > 0 Then
                If DT.Rows(0).Item(0) = "Bank A/C" Or DT.Rows(0).Item(0) = "Bank OD A/C" Then
                    MSG = "Hi, Your Account is Credited by Chq for Rs. " & Val(txtchqamt.Text.Trim) & Chr(13) & "Chq No - " & txtchqno.Text.Trim & Chr(13) & "Bank - " & TXTBANKNAME.Text.Trim & Chr(13) & "Dt-" & ACCDATE.Text
                ElseIf DT.Rows(0).Item(0) = "Cash In Hand" Then
                    MSG = "Hi, Your Account is Credited by Cash for Rs. " & Val(txtchqamt.Text.Trim) & Chr(13) & "Dt-" & ACCDATE.Text
                End If
            End If
