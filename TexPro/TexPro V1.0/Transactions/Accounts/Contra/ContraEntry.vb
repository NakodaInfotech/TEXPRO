...
Public Class ContraEntry
    ...
    Private Sub cmbname_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles cmbname.Validating
        Try
            If cmbname.Text.Trim <> "" Then namevalidate(cmbname, e, Me, TXTADD, " AND (GROUPMASTER.GROUP_SECONDARY = 'CASH IN HAND' OR GROUPMASTER.GROUP_SECONDARY ='BANK A/C' OR GROUPMASTER.GROUP_SECONDARY ='BANK OD A/C')")
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
