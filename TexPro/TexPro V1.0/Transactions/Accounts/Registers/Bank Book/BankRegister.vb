...
Public Class BankRegister
    ...
    Private Sub cmbbank_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles cmbbank.Validating
        Try
            If cmbbank.Text.Trim <> "" Then ledgervalidate(cmbbank, CMBACCCODE, e, Me, txtadd, " AND (GROUPMASTER.group_SECONDARY = 'BANK A/C' OR GROUPMASTER.group_SECONDARY = 'BANK OD A/C') AND LEDGERS.ACC_YEARID = " & YearId)
            fillgrid()
        Catch ex As Exception
            Throw ex
        End Try
