...
Partial Class LedgerBillwise
    ...
    Private Sub InitializeComponent()
        ...
        GridLevelNode2.LevelTemplate = Me.GRIDREC
        GridLevelNode2.RelationName = "BILLDETAILS"
        Me.griddetails.LevelTree.Nodes.AddRange(New DevExpress.XtraGrid.GridLevelNode() {GridLevelNode2})
