...
Public Class InterGodownTransferDetails
    ...
    Sub showform(ByVal editval As Boolean, ByVal GODOWNNO As Integer)
        Try
    ...
    Private Sub PrintToolStripButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PrintToolStripButton.Click
        Try
            ...
            Dim PATH As String = Application.StartupPath & "\Transfer Details.XLS"
            ...
            For Each proc In System.Diagnostics.Process.GetProcessesByName("Excel")
                proc.Kill()
            Next
            opti.SheetName = "Transfer Details"
            gridbill.ExportToXls(PATH, opti)
            EXCELCMPHEADER(PATH, "Transfer Details", gridbill.VisibleColumns.Count + gridbill.GroupCount)
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
