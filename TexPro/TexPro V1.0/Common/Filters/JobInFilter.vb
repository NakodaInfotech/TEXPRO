...
Public Class JobInFilter
    ...
    Private Sub JobInFilter_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Private Sub JobInFilter_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
            fillcmb()
        Catch ex As Exception
            If ErrHandle(ex.Message.GetHashCode) = False Then Throw ex
    ...
    Private Sub cmdshowreport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdshowreport.Click
        ...
        formula = " {JOBIN.JI_YEARID}= " & YearId
        ...
        If RDBDETAIL.Checked = True Then objstock.FRMSTRING = "JIDTLS"
        If RDBPARTYWISEDETAIL.Checked = True Then objstock.FRMSTRING = "JIPARTYWISE"
