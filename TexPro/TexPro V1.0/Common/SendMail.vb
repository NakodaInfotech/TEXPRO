...
Public Class SendMail
    ...
    Private Sub cmdok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdok.Click
        Try
            ...
            If cmbfirstadd.Text.Trim <> Nothing Then sendemail(cmbfirstadd.Text.Trim, attachment, txtmailbody.Text.Trim, subject, ALATTACHMENT, ALATTACHMENT.Count)
            If cmbsecondadd.Text.Trim <> Nothing Then sendemail(cmbsecondadd.Text.Trim, attachment, txtmailbody.Text.Trim, subject, ALATTACHMENT, ALATTACHMENT.Count)
            If cmbthirdadd.Text.Trim <> Nothing Then sendemail(cmbthirdadd.Text.Trim, attachment, txtmailbody.Text.Trim, subject, ALATTACHMENT, ALATTACHMENT.Count)
            If cmbfourthadd.Text.Trim <> Nothing Then sendemail(cmbfourthadd.Text.Trim, attachment, txtmailbody.Text.Trim, subject, ALATTACHMENT, ALATTACHMENT.Count)
            If cmbfifthadd.Text.Trim <> Nothing Then sendemail(cmbfifthadd.Text.Trim, attachment, txtmailbody.Text.Trim, subject, ALATTACHMENT, ALATTACHMENT.Count)
