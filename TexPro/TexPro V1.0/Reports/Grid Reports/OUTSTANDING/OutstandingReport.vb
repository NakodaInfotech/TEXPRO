...
Public Class OutstandingReport
    ...
    Sub fillgrid()
        ...
        If chkpaid.CheckState = CheckState.Checked Then
            WHERECLAUSE = WHERECLAUSE & " AND BALANCE < GRANDTOTAL "
        ElseIf chkall.Checked = True Then
            WHERECLAUSE = WHERECLAUSE & ""
        ElseIf chkall.Checked = False Then
            WHERECLAUSE = WHERECLAUSE & " AND BALANCE > 0 "
        End If
        ...
        Dim OBJCMN As New ClsCommon
        Dim dt As DataTable = OBJCMN.search(" DATE, NAME,TYPE,BILLINITIALS,REFNO, (CASE WHEN GRANDTOTAL > 0 THEN BALANCE  ELSE 0 END) AS DEBIT, (CASE WHEN GRANDTOTAL = 0 THEN SUM(RECAMT) ELSE 0 END) AS CREDIT, BILL, REGTYPE, REMARKS, USERNAME ", "", " OUTSTANDINGREPORT_DETAILS ", " AND NAME = '" & cmbname.Text.Trim & "' " & WHERECLAUSE & " GROUP BY DATE, NAME,TYPE,BILLINITIALS,REFNO,BALANCE, GRANDTOTAL, BILL, REGTYPE, REMARKS, USERNAME")
        Dim DT1 As DataTable = OBJCMN.search(" RECINITIALS, RECDATE,ACCNAME,RECAMT, BILLINITIALS, RECREMARKS , RECUSERNAME, RECNO, RECREGTYPE, RECTYPE ", "", " OUTSTANDINGREPORT_DETAILS ", " AND NAME = '" & cmbname.Text.Trim & "' AND RECAMT > 0 AND GRANDTOTAL > 0 " & WHERECLAUSE)
        ...
        DTSET.Relations.Add("BILLDETAILS", DTSET.Tables("PAID").Columns("BILLINITIALS"), DTSET.Tables("RECEIPT").Columns("BILLINITIALS"), False)
    ...
    Private Sub cmbname_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles cmbname.Validating
        Try
            If cmbname.Text.Trim <> "" Then namevalidate(cmbname, e, Me, txtadd, " and ledgers.acc_cmpname = '" & cmbname.Text.Trim & "'")
        Catch ex As Exception
            Throw ex
        End Try
    End Sub

    Private Sub OutstandingReport_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Private Sub OutstandingReport_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
    ...
    Private Sub OutstandingReport_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
