...
Public Class MFGDETAILREPORTPCS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.MFGDETAILREPORTPCS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMFGDETAILREPORTPCS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MFGDETAILREPORTPCS = New MFGDETAILREPORTPCS()
        rpt.Site = Me.Site
        Return rpt
    End Function
