...
Public Class MFG2STOCKSUMMARYreport_New
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "MFG2STOCKSUMMARYreport_New.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.MFG2STOCKSUMMARYreport_New.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMFG2STOCKSUMMARYreport_New
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MFG2STOCKSUMMARYreport_New = New MFG2STOCKSUMMARYreport_New()
        rpt.Site = Me.Site
        Return rpt
    End Function
