...
Public Class MFG2merchantreport_New
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "MFG2merchantreport_New.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.MFG2merchantreport_New.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMFG2merchantreport_New
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MFG2merchantreport_New = New MFG2merchantreport_New()
        rpt.Site = Me.Site
        Return rpt
    End Function
