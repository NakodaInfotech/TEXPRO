...
Public Class DyeingIssueSlip
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.DyeingIssueSlip.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDyeingIssueSlip
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DyeingIssueSlip = New DyeingIssueSlip()
        rpt.Site = Me.Site
        Return rpt
    End Function
