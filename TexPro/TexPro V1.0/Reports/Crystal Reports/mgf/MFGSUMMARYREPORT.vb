...
Public Class MFGSUMMARYREPORT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.MFGSUMMARYREPORT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMFGSUMMARYREPORT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MFGSUMMARYREPORT = New MFGSUMMARYREPORT()
        rpt.Site = Me.Site
        Return rpt
    End Function
