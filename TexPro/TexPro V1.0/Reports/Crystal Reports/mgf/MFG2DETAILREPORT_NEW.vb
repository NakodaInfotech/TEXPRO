...
Public Class MFG2DETAILREPORT_NEW
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "MFG2DETAILREPORT_NEW.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.MFG2DETAILREPORT_NEW.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMFG2DETAILREPORT_NEW
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MFG2DETAILREPORT_NEW = New MFG2DETAILREPORT_NEW()
        rpt.Site = Me.Site
        Return rpt
    End Function
