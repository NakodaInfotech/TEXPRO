...
Public Class Procianreport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.Procianreport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedProcianreport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Procianreport = New Procianreport()
        rpt.Site = Me.Site
        Return rpt
    End Function
