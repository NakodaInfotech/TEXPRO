...
Public Class MFGDETAILREPORTVALUE
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "MFGDETAILREPORTVALUE.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.MFGDETAILREPORTVALUE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMFGDETAILREPORTVALUE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MFGDETAILREPORTVALUE = New MFGDETAILREPORTVALUE()
        rpt.Site = Me.Site
        Return rpt
    End Function
