...
Public Class MemoStockReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.MemoStockReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMemoStockReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MemoStockReport = New MemoStockReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
