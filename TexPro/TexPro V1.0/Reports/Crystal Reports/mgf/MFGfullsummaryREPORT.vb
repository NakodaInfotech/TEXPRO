...
Public Class MFGfullsummaryREPORT
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "MFGfullsummaryREPORT.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.MFGfullsummaryREPORT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMFGfullsummaryREPORT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MFGfullsummaryREPORT = New MFGfullsummaryREPORT()
        rpt.Site = Me.Site
        Return rpt
    End Function
