...
Public Class CreditNoteReportold
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CreditNoteReportold.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.CreditNoteReportold.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCreditNoteReportold
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CreditNoteReportold = New CreditNoteReportold()
        rpt.Site = Me.Site
        Return rpt
    End Function
