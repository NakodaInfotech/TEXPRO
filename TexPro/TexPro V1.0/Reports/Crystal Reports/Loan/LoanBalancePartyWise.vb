...
Public Class LoanBalancePartyWise
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "LoanBalancePartyWise.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.LoanBalancePartyWise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLoanBalancePartyWise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LoanBalancePartyWise = New LoanBalancePartyWise()
        rpt.Site = Me.Site
        Return rpt
    End Function
