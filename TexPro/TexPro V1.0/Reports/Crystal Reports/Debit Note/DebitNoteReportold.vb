...
Public Class DebitNoteReportold
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.DebitNoteReportold.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDebitNoteReportold
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DebitNoteReportold = New DebitNoteReportold()
        rpt.Site = Me.Site
        Return rpt
    End Function
