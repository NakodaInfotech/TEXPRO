...
Public Class GPREPORT_TULSI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.GPREPORT_TULSI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGPREPORT_TULSI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GPREPORT_TULSI = New GPREPORT_TULSI()
        rpt.Site = Me.Site
        Return rpt
    End Function
