...
Public Class PENDINGJOREPORTOURQUALITY
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PENDINGJOREPORTOURQUALITY.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.PENDINGJOREPORTOURQUALITY.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPENDINGJOREPORTOURQUALITY
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PENDINGJOREPORTOURQUALITY = New PENDINGJOREPORTOURQUALITY()
        rpt.Site = Me.Site
        Return rpt
    End Function
