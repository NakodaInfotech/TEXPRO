...
Public Class JobInDtlsReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.JobInDtlsReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedJobInDtlsReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As JobInDtlsReport = New JobInDtlsReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
