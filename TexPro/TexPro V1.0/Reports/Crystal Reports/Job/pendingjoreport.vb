...
Public Class pendingjoreport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.pendingjoreport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedpendingjoreport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As pendingjoreport = New pendingjoreport()
        rpt.Site = Me.Site
        Return rpt
    End Function
