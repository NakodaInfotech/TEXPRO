...
Public Class PARTYWISECHECKING_Summary
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PARTYWISECHECKING_Summary.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.PARTYWISECHECKING_Summary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPARTYWISECHECKING_Summary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PARTYWISECHECKING_Summary = New PARTYWISECHECKING_Summary()
        rpt.Site = Me.Site
        Return rpt
    End Function
