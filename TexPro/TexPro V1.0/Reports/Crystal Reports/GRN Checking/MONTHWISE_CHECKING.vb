...
Public Class MONTHWISE_CHECKING
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.MONTHWISE_CHECKING.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMONTHWISE_CHECKING
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MONTHWISE_CHECKING = New MONTHWISE_CHECKING()
        rpt.Site = Me.Site
        Return rpt
    End Function
