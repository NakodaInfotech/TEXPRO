...
Public Class GRNCheckingreport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.GRNCheckingreport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGRNCheckingreport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GRNCheckingreport = New GRNCheckingreport()
        rpt.Site = Me.Site
        Return rpt
    End Function
