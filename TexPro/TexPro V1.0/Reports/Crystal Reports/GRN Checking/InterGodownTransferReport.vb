...
Public Class InterGodownTransferReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "InterGodownTransferReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.InterGodownTransferReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInterGodownTransferReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InterGodownTransferReport = New InterGodownTransferReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
