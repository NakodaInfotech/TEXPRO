...
Public Class JobWiseConsumption
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.JobWiseConsumption.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedJobWiseConsumption
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As JobWiseConsumption = New JobWiseConsumption()
        rpt.Site = Me.Site
        Return rpt
    End Function
