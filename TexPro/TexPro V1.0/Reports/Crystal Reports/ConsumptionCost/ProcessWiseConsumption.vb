...
Public Class ProcessWiseConsumption
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ProcessWiseConsumption.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.ProcessWiseConsumption.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedProcessWiseConsumption
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ProcessWiseConsumption = New ProcessWiseConsumption()
        rpt.Site = Me.Site
        Return rpt
    End Function
