...
Public Class PurchaseQuotReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.PurchaseQuotReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPurchaseQuotReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PurchaseQuotReport = New PurchaseQuotReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
