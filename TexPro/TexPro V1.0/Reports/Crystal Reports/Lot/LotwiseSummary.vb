...
Public Class LotwiseSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.LotwiseSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLotwiseSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LotwiseSummary = New LotwiseSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
