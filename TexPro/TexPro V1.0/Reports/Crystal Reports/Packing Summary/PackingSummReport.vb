...
Public Class PackingSummReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.PackingSummReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPackingSummReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PackingSummReport = New PackingSummReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
