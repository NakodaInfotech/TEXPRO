...
Public Class FCPVALUELOSSREPORT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.FCPVALUELOSSREPORT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFCPVALUELOSSREPORT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FCPVALUELOSSREPORT = New FCPVALUELOSSREPORT()
        rpt.Site = Me.Site
        Return rpt
    End Function
