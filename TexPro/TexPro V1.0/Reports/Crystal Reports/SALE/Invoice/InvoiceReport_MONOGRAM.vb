...
Public Class InvoiceReport_MONOGRAM
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "InvoiceReport_MONOGRAM.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.InvoiceReport_MONOGRAM.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvoiceReport_MONOGRAM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvoiceReport_MONOGRAM = New InvoiceReport_MONOGRAM()
        rpt.Site = Me.Site
        Return rpt
    End Function
