...
Public Class gdnSummaryreport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.gdnSummaryreport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedgdnSummaryreport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As gdnSummaryreport = New gdnSummaryreport()
        rpt.Site = Me.Site
        Return rpt
    End Function
