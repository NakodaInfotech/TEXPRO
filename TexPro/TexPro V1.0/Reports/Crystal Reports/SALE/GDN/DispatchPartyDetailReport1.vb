...
Public Class DispatchPartyDetailReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "DispatchPartyDetailReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.DispatchPartyDetailReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDispatchPartyDetailReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DispatchPartyDetailReport = New DispatchPartyDetailReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
