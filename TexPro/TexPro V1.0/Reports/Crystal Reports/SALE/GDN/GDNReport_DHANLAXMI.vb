...
Public Class GDNReport_DHANLAXMI
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "GDNReport_DHANLAXMI.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.GDNReport_DHANLAXMI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGDNReport_DHANLAXMI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GDNReport_DHANLAXMI = New GDNReport_DHANLAXMI()
        rpt.Site = Me.Site
        Return rpt
    End Function
