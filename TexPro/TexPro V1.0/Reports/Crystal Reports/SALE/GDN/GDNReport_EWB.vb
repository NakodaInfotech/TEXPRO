...
Public Class GDNReport_EWB
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.GDNReport_EWB.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGDNReport_EWB
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GDNReport_EWB = New GDNReport_EWB()
        rpt.Site = Me.Site
        Return rpt
    End Function
