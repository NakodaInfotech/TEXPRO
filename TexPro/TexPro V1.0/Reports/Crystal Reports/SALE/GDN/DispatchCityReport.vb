...
Public Class DispatchCityReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.DispatchCityReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDispatchCityReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DispatchCityReport = New DispatchCityReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
