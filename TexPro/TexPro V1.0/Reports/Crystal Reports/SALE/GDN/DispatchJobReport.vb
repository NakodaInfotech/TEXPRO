...
Public Class DispatchJobReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.DispatchJobReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDispatchJobReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DispatchJobReport = New DispatchJobReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
