...
Public Class DispatchJobWise
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.DispatchJobWise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDispatchJobWise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DispatchJobWise = New DispatchJobWise()
        rpt.Site = Me.Site
        Return rpt
    End Function
