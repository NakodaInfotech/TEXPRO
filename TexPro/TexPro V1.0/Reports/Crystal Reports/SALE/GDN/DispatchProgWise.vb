...
Public Class DispatchProgWise
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.DispatchProgWise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDispatchProgWise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DispatchProgWise = New DispatchProgWise()
        rpt.Site = Me.Site
        Return rpt
    End Function
