...
Public Class DispatchPartyReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "DispatchPartyReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.DispatchPartyReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDispatchPartyReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DispatchPartyReport = New DispatchPartyReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
