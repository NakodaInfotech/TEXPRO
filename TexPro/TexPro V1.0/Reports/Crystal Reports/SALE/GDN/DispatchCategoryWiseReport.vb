...
Public Class DispatchCategoryWiseReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "DispatchCategoryWiseReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.DispatchCategoryWiseReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDispatchCategoryWiseReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DispatchCategoryWiseReport = New DispatchCategoryWiseReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
