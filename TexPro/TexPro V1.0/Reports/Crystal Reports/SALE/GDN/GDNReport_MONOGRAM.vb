...
Public Class GDNReport_MONOGRAM
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.GDNReport_MONOGRAM.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGDNReport_MONOGRAM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GDNReport_MONOGRAM = New GDNReport_MONOGRAM()
        rpt.Site = Me.Site
        Return rpt
    End Function
