...
Public Class BALESTOCK_NORMALVALUE
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "BALESTOCK_NORMALVALUE.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.BALESTOCK_NORMALVALUE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBALESTOCK_NORMALVALUE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BALESTOCK_NORMALVALUE = New BALESTOCK_NORMALVALUE()
        rpt.Site = Me.Site
        Return rpt
    End Function
