...
Public Class stock_GRNWise_approval
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "stock_GRNWise_approval.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.stock_GRNWise_approval.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedstock_GRNWise_approval
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As stock_GRNWise_approval = New stock_GRNWise_approval()
        rpt.Site = Me.Site
        Return rpt
    End Function
