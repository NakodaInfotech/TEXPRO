...
Public Class BALESTOCK_NORMALLOT
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "BALESTOCK_NORMALLOT.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.BALESTOCK_NORMALLOT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBALESTOCK_NORMALLOT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BALESTOCK_NORMALLOT = New BALESTOCK_NORMALLOT()
        rpt.Site = Me.Site
        Return rpt
    End Function
