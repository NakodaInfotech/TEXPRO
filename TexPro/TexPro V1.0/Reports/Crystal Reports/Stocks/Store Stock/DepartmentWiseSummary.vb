...
Public Class DepartmentWiseSummary
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "DepartmentWiseSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.DepartmentWiseSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDepartmentWiseSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DepartmentWiseSummary = New DepartmentWiseSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
