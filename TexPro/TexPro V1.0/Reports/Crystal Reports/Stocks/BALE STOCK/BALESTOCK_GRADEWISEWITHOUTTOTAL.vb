...
Public Class BALESTOCK_GRADEWISEWITHOUTTOTAL
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "BALESTOCK_GRADEWISEWITHOUTTOTAL.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.BALESTOCK_GRADEWISEWITHOUTTOTAL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBALESTOCK_GRADEWISEWITHOUTTOTAL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BALESTOCK_GRADEWISEWITHOUTTOTAL = New BALESTOCK_GRADEWISEWITHOUTTOTAL()
        rpt.Site = Me.Site
        Return rpt
    End Function
