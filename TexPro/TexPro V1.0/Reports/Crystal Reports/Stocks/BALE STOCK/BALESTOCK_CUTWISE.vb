...
Public Class BALESTOCK_CUTWISE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.BALESTOCK_CUTWISE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBALESTOCK_CUTWISE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BALESTOCK_CUTWISE = New BALESTOCK_CUTWISE()
        rpt.Site = Me.Site
        Return rpt
    End Function
