...
Public Class BALESTOCK_MERCHANTWISEWITHOUTTOTAL
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "BALESTOCK_MERCHANTWISEWITHOUTTOTAL.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.BALESTOCK_MERCHANTWISEWITHOUTTOTAL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBALESTOCK_MERCHANTWISEWITHOUTTOTAL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BALESTOCK_MERCHANTWISEWITHOUTTOTAL = New BALESTOCK_MERCHANTWISEWITHOUTTOTAL()
        rpt.Site = Me.Site
        Return rpt
    End Function
