...
Public Class BALESTOCK_DESIGNWISE
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "BALESTOCK_DESIGNWISE.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.BALESTOCK_DESIGNWISE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBALESTOCK_DESIGNWISE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BALESTOCK_DESIGNWISE = New BALESTOCK_DESIGNWISE()
        rpt.Site = Me.Site
        Return rpt
    End Function
