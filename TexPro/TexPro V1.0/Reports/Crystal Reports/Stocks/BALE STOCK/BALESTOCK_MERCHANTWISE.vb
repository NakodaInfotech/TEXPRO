...
Public Class BALESTOCK_MERCHANTWISE
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "BALESTOCK_MERCHANTWISE.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.BALESTOCK_MERCHANTWISE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBALESTOCK_MERCHANTWISE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BALESTOCK_MERCHANTWISE = New BALESTOCK_MERCHANTWISE()
        rpt.Site = Me.Site
        Return rpt
    End Function
