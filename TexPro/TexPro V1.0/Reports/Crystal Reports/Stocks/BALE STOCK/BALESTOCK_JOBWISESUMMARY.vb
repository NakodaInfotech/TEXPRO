...
Public Class BALESTOCK_JOBWISESUMMARY
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "BALESTOCK_JOBWISESUMMARY.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.BALESTOCK_JOBWISESUMMARY.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBALESTOCK_JOBWISESUMMARY
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BALESTOCK_JOBWISESUMMARY = New BALESTOCK_JOBWISESUMMARY()
        rpt.Site = Me.Site
        Return rpt
    End Function
