...
Public Class BALESTOCK_DEPARTMENTWISE
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "BALESTOCK_DEPARTMENTWISE.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.BALESTOCK_DEPARTMENTWISE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBALESTOCK_DEPARTMENTWISE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BALESTOCK_DEPARTMENTWISE = New BALESTOCK_DEPARTMENTWISE()
        rpt.Site = Me.Site
        Return rpt
    End Function
