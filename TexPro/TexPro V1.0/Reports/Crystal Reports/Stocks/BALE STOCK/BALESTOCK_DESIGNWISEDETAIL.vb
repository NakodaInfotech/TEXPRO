...
Public Class BALESTOCK_DESIGNWISEDETAIL
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "BALESTOCK_DESIGNWISEDETAIL.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.BALESTOCK_DESIGNWISEDETAIL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBALESTOCK_DESIGNWISEDETAIL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BALESTOCK_DESIGNWISEDETAIL = New BALESTOCK_DESIGNWISEDETAIL()
        rpt.Site = Me.Site
        Return rpt
    End Function
