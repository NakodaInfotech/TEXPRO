...
Public Class Stocks_Rejected_Summary
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Stocks_Rejected_Summary.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.Stocks_Rejected_Summary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStocks_Rejected_Summary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Stocks_Rejected_Summary = New Stocks_Rejected_Summary()
        rpt.Site = Me.Site
        Return rpt
    End Function
