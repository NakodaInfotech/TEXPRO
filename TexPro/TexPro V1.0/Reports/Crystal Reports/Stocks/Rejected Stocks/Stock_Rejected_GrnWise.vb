...
Public Class Stock_Rejected_GrnWise
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Stock_Rejected_GrnWise.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.Stock_Rejected_GrnWise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStock_Rejected_GrnWise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Stock_Rejected_GrnWise = New Stock_Rejected_GrnWise()
        rpt.Site = Me.Site
        Return rpt
    End Function
