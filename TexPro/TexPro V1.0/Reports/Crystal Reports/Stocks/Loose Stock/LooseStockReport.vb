...
Public Class LooseStockReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.LooseStockReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLooseStockReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LooseStockReport = New LooseStockReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
