...
Public Class LooseStockDesignReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "LooseStockDesignReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.LooseStockDesignReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLooseStockDesignReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LooseStockDesignReport = New LooseStockDesignReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
