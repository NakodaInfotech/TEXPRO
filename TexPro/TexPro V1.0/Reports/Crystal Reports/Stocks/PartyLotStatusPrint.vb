...
Public Class PartyLotStatusPrint
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PartyLotStatusPrint.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.PartyLotStatusPrint.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPartyLotStatusPrint
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PartyLotStatusPrint = New PartyLotStatusPrint()
        rpt.Site = Me.Site
        Return rpt
    End Function
