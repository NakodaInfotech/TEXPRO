...
Public Class Fpsreport_RND
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.Fpsreport_RND.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFpsreport_RND
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Fpsreport_RND = New Fpsreport_RND()
        rpt.Site = Me.Site
        Return rpt
    End Function
