...
Public Class FPSProcessTypeReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "FPSProcessTypeReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.FPSProcessTypeReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFPSProcessTypeReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FPSProcessTypeReport = New FPSProcessTypeReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
