...
Public Class FPSPiecetypeReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.FPSPiecetypeReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFPSPiecetypeReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FPSPiecetypeReport = New FPSPiecetypeReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
