...
Public Class FINALPACKINGSLIP_MONOGRAM
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "FINALPACKINGSLIP_MONOGRAM.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.FINALPACKINGSLIP_MONOGRAM.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFINALPACKINGSLIP_MONOGRAM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FINALPACKINGSLIP_MONOGRAM = New FINALPACKINGSLIP_MONOGRAM()
        rpt.Site = Me.Site
        Return rpt
    End Function
