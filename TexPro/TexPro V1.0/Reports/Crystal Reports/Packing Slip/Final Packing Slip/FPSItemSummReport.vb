...
Public Class FPSItemSummReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.FPSItemSummReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFPSItemSummReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FPSItemSummReport = New FPSItemSummReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
