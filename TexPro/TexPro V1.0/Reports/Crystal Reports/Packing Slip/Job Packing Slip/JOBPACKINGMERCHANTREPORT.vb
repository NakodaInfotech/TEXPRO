...
Public Class JOBPACKINGMERCHANTREPORT
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "JOBPACKINGMERCHANTREPORT.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.JOBPACKINGMERCHANTREPORT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedJOBPACKINGMERCHANTREPORT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As JOBPACKINGMERCHANTREPORT = New JOBPACKINGMERCHANTREPORT()
        rpt.Site = Me.Site
        Return rpt
    End Function
