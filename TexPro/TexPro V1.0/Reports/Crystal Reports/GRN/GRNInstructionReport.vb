...
Public Class GRNInstructionReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "GRNInstructionReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.GRNInstructionReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGRNInstructionReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GRNInstructionReport = New GRNInstructionReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
