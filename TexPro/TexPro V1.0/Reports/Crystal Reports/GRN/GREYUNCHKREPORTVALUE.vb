...
Public Class GREYUNCHKREPORTVALUE
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "GREYUNCHKREPORTVALUE.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.GREYUNCHKREPORTVALUE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGREYUNCHKREPORTVALUE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GREYUNCHKREPORTVALUE = New GREYUNCHKREPORTVALUE()
        rpt.Site = Me.Site
        Return rpt
    End Function
