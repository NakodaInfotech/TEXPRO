...
Public Class GREYUNCHKREPORT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.GREYUNCHKREPORT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGREYUNCHKREPORT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GREYUNCHKREPORT = New GREYUNCHKREPORT()
        rpt.Site = Me.Site
        Return rpt
    End Function
