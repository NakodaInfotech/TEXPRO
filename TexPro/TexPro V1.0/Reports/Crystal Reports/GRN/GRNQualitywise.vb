...
Public Class GRNQualitywise
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.GRNQualitywise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGRNQualitywise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GRNQualitywise = New GRNQualitywise()
        rpt.Site = Me.Site
        Return rpt
    End Function
