...
Public Class CHECKINGALLGRN
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.CHECKINGALLGRN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCHECKINGALLGRN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CHECKINGALLGRN = New CHECKINGALLGRN()
        rpt.Site = Me.Site
        Return rpt
    End Function
