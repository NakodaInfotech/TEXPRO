...
Public Class GREYCHKREPORTVALUE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.GREYCHKREPORTVALUE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGREYCHKREPORTVALUE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GREYCHKREPORTVALUE = New GREYCHKREPORTVALUE()
        rpt.Site = Me.Site
        Return rpt
    End Function
