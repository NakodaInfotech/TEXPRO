...
Public Class GRNGreyWtReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TexPro_V1.GRNGreyWtReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGRNGreyWtReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GRNGreyWtReport = New GRNGreyWtReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
