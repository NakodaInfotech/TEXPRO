...
Public Class Taxmaster
    ...
    Private Sub Taxmaster_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If edit = True Then
            ...
            dttable = objCommon.search(" tax_name,tax_tax, tax_remarks ", "", "TaxMaster", " and tax_id = " & tempid)
    ...
    Private Sub cmddelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmddelete.Click
        Try
            If edit = True Then
                ...
                Dim tempmsg As Integer = MsgBox("Delete Tax Permanently?", MsgBoxStyle.YesNo, "Eagle Travels")
