    ...
    Private Sub CmpExciseInf_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If EDIT = True Then
                ...
                DT = OBJCMN.search("CMP_BUSINESSLINE, CMP_CSTNO, CMP_STNO, CMP_PANNO, CMP_ECCNO, CMP_EXCISENO, CMP_MSMENO, CMP_DIVISION, CMP_BANKNAME, CMP_BANKACNO, CMP_IFSCCODE,CMP_COMMISSIONERATE, CMP_HEADINGNO, CMP_GSTIN AS GSTIN, CMP_EWBUSER AS EWBUSER, CMP_EWBPASS AS EWBPASS, CMP_DISPATCHFROM AS DISPATCHFROM, ISNULL(CITY_NAME,'') AS FROMCITY ", "", " CMPMASTER LEFT OUTER JOIN CITYMASTER ON CMP_FROMCITYID = CITY_ID", " AND CMP_NAME = '" & TEMPCMPNAME & "'")
                ...
                txtmsmseno.Text = DTROW(6).ToString
