...
Public Class addressdetails
    ...
    Sub fillgrid()
        ...
        dttable = objClsCommon.search(" address_id,ACCOUNTSMASTER.ACC_cmpname As Buyer, address_alias as Consignee, address_full as [Del. Add.] ", "", "ADDRESSMASTER INNER JOIN ACCOUNTSMASTER ON ADDRESSMASTER.ADDRESS_LEDGERID = ACCOUNTSMASTER.ACC_id AND ADDRESSMASTER.ADDRESS_cmpid = ACCOUNTSMASTER.ACC_cmpid AND ADDRESSMASTER.ADDRESS_locationid = ACCOUNTSMASTER.ACC_locationid AND ADDRESSMASTER.ADDRESS_yearid = ACCOUNTSMASTER.ACC_yearid ", " and address_cmpid = " & CmpId & " and address_locationid = " & Locationid & " and address_yearid = " & YearId)
