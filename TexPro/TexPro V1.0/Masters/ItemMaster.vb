...
Public Class ItemMaster
    ...
    Private Sub cmdok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdok.Click
        Try
            ...
            If CHKDYEDSTOCK.CheckState = CheckState.Checked Then alParaval.Add(1) Else alParaval.Add(0)
            If CHKSHOWINPRGREPORT.CheckState = CheckState.Checked Then alParaval.Add(1) Else alParaval.Add(0)
            alParaval.Add(CMBPRGCATEGORY.Text.Trim)
    ...
    Sub clear()
        ...
        CMBSUBCATEGORY.Text = ""
        CMBFOLD.Text = ""
        CHKDYEDSTOCK.Checked = False
        CHKSHOWINPRGREPORT.Checked = False
        CMBPRGCATEGORY.Text = ""
...
#End Region
            ...
            If edit = True Then
                ...
                If dttable.Rows.Count > 0 Then
                    For Each ROW As DataRow In dttable.Rows
                        ...
                        CHKDYEDSTOCK.Checked = Convert.ToBoolean(dttable.Rows(0).Item("DYEDSTOCK"))
                        CHKSHOWINPRGREPORT.Checked = Convert.ToBoolean(dttable.Rows(0).Item("SHOWINPRGREPORT"))
                        CMBPRGCATEGORY.Text = ROW("PRGCATEGORY")
    ...
    Private Sub ItemMaster_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        Try
            ...
            If ClientName = "TULSI" Then
                ...
                CHKDYEDSTOCK.Visible = True
                CHKSHOWINPRGREPORT.Visible = True
                LBLPRGCATEGORY.Visible = True
                CMBPRGCATEGORY.Visible = True
            End If
        Catch ex As Exception
            Throw ex
        End Try
    ...
    Private Sub CMBPRGCATEGORY_Validating(sender As Object, e As CancelEventArgs) Handles CMBPRGCATEGORY.Validating
        Try
            If CMBPRGCATEGORY.Text.Trim <> "" Then CATEGORYVALIDATE(CMBPRGCATEGORY, e, Me)
        Catch ex As Exception
            If ErrHandle(ex.Message.GetHashCode) = False Then Throw ex
        End Try
    End Sub
