...
Public Class CityDetails
    ...
    Private Sub CityDetails_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            ElseIf frmstring = "EXPMASTER" Then
                DTROW = USERRIGHTS.Select("FormName = 'RATE TYPE MASTER'")
            Else
    ...
    Sub fillgrid()
        ...
        ElseIf frmstring = "EXPMASTER" Then
            dttable = objClsCommon.search(" EXP_name, EXP_id", "", "EXPENSEMASTER", " and EXP_cmpid = " & CmpId & " and EXP_locationid = " & Locationid & " and EXP_yearid = " & YearId)
        End If
