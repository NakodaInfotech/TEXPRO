...
Public Class UserMaster
    ...
    Private Sub UserMaster_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If edit = True Then
                ...
                'DTUSER = objcmn.search(" DISTINCT  User_formName as [FormName], User_add as Addf, User_Edit as Editf, User_View as Viewf, User_Delete as Deletef ", "", "USERMASTER_RIGHTS INNER JOIN USERMASTER ON USERMASTER.USER_ID = USERMASTER_RIGHTS.USER_ID AND USERMASTER.USER_CMPID = USERMASTER_RIGHTS.USER_CMPID", " and USERMASTER.USER_NAME = '" & Uname & "' and Usermaster.User_cmpid = " & CmpId & " ORDER BY USER_FORMNAME")
    ...
    Private Sub cmdok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdok.Click
        Try
            ...
            For Each obj As Object In CHK
                Dim objcmn As New ClsCommon
                Dim dt As DataTable
                dt = objcmn.search("MAX(cmp_id),MAX(year_id)", "", "cmpmaster inner join yearmaster ON YEAR_CMPID = CMP_ID", " AND CMP_NAME ='" & CHK.Item(0) & "'")
    ...
    Private Sub ToolStripdelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripdelete.Click
        Try
            If edit = True Then
                Dim tempmsg As Integer = MsgBox("Delete User Permanently?", MsgBoxStyle.YesNo, "texpro")
                If tempmsg = vbYes Then
