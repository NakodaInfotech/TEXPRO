...
Public Class citymaster
    ...
    Private Sub cmdok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdok.Click
        ...
        Try
            ...
            ElseIf frmstring = "EXPMASTER" Then
                Dim objyear As New ClsYearMaster
                If edit = False Then
                    If USERADD = False Then
                        MsgBox("Insufficient Rights")
                        Exit Sub
                    End If
                    IntResult = objyear.saveexpense(txtname.Text.Trim, CmpId, Locationid, Userid, YearId, " and EXP_name='" & txtname.Text.Trim & "' and EXP_cmpid = " & CmpId & " and EXP_Locationid = " & Locationid & " and EXP_yearid = " & YearId, txtremarks.Text.Trim)
                    MsgBox("Expense Added")
                ElseIf edit = True Then
                    If USEREDIT = False Then
                        MsgBox("Insufficient Rights")
                        Exit Sub
                    ...
                    alParaval.Add(tempid)
                    objCity.alParaval = alParaval
                    IntResult = objCity.UpdateExpense()
    ...
    Private Sub citymaster_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            ElseIf frmstring = "EXPMASTER" Then
                ...
                lblgroup.Text = "Expense"
                lbl.Text = "Enter Expense "
                If edit = True Then dttable = objCommon.search(" exp_name, EXP_REMARKS", "", "ExpenseMaster", " and exp_id = " & tempid & " and exp_cmpid = " & CmpId & " and exp_Locationid = " & Locationid & " and exp_yearid = " & YearId)
            ...
            If (edit = False) Or (edit = True And LCase(tempname) <> LCase(txtname.Text.Trim)) Then
                ...
                If txtname.Text.Trim <> Nothing Then
                    ...
                    If frmstring = "CITYMASTER" Then
                        ...
                        If dt.Rows.Count > 0 Then
                            MsgBox("City Name Already Exists", MsgBoxStyle.Critical, "Tex Pro")
                            e.Cancel = True
                        End If
                    ElseIf frmstring = "AREAMASTER" Then
                        ...
                        If dt.Rows.Count > 0 Then
                            MsgBox("Area Name Already Exists", MsgBoxStyle.Critical, "Tex Pro")
                            e.Cancel = True
                        End If

                    ElseIf frmstring = "EXPMASTER" Then
                        dt = objclscommon.search("EXP_name", "", "EXPENSEmaster", " and EXP_name = '" & txtname.Text.Trim & "'and EXP_cmpid = " & CmpId & " and EXP_Locationid = " & Locationid & " and EXP_yearid = " & YearId)
                        If dt.Rows.Count > 0 Then
                            MsgBox("EXPENSE Already Exists", MsgBoxStyle.Critical, "Tex Pro")
                            e.Cancel = True
                        End If
                    ...
                    ElseIf frmstring = "FORMTYPE" Then
                        ...
                        If dt.Rows.Count > 0 Then
                            MsgBox("FORm Name Already Exists", MsgBoxStyle.Critical, "Tex Pro")
                            e.Cancel = True
                        End If
                    ...
                    ElseIf frmstring = "STATEMASTER" Then
                        ...
                        If dt.Rows.Count > 0 Then
                            MsgBox("State Name Already Exists", MsgBoxStyle.Critical, "Tex Pro")
                            e.Cancel = True
                        End If
                    ElseIf frmstring = "COUNTRYMASTER" Then
                        ...
                        If dt.Rows.Count > 0 Then
                            MsgBox("Country Name Already Exists", MsgBoxStyle.Critical, "Tex Pro")
                            e.Cancel = True
                        End If
                    End If
                    pcase(txtname)
    ...
    Private Sub cmddelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmddelete.Click
        Try
            ...
            If frmstring = "EXPMASTER" And edit = True Then
                If MsgBox("Wish to Delete Entry?", MsgBoxStyle.YesNo) = MsgBoxResult.No Then Exit Sub
                Dim OBJCMN As New ClsCommon
                Dim DT As DataTable = OBJCMN.Execute_Any_String("DELETE FROM EXPENSEMASTER  where EXP_id = " & tempid, "", "")
        ...
        Try
            If frmstring = "STATEMASTER" And txtremarks.Text.Trim <> "" Then
                If (EDIT = False) Or (EDIT = True And txtremarks.Text.Trim <> TEMPSTATECODE) Then
                    ...
                    If DT.Rows.Count > 0 Then
                        MsgBox("State Code Already Exists", MsgBoxStyle.Critical, "TEXPRO")
                        e.Cancel = True
                        Exit Sub
                    End If
                End If
