...
#Region "Functions"
    ...
    Public Function save() As Integer
        ...
        Try
            'save SALE order
            Dim strCommand As String = "SP_TRANS_MFG_BALEOPEN_SAVE"
    ...
    Public Function Update() As Integer
        ...
        Try
            'Update SALE order
            Dim strCommand As String = "SP_TRANS_MFG_BALEOPEN_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@BO_NO", alParaval(I)))
                I = I + 1
            End With
            intResult = objDBOperation.executeNonQuery(strCommand, alParameter)
    ...
    Public Function selectBO() As DataTable
        Dim dtTable As DataTable
        Try

            Dim strCommand As String = "SP_SELECTBO_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter

                Dim I As Integer = 0

                .Add(New SqlClient.SqlParameter("@BOno", alParaval(I)))
                I = I + 1
                .Add(New SqlClient.SqlParameter("@CmpID", alParaval(I)))
                I = I + 1
                .Add(New SqlClient.SqlParameter("@LocationID", alParaval(I)))
    ...
    Public Function Delete() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_TRANS_MFG_BALEOPEN_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@BO_no", alParaval(0)))
