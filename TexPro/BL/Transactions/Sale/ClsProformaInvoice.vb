...
#Region "Functions"
    ...
    Public Function save() As Integer
        ...
        Try
            ...
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@DELADD", alParaval(I)))
                I = I + 1
                ...
                .Add(New SqlClient.SqlParameter("@INVOICEDONE", alParaval(I)))
                I = I + 1
                ...
                I = I + 1
                .Add(New SqlClient.SqlParameter("@INVOICEGRIDDONE", alParaval(I)))
                I = I + 1
                .Add(New SqlClient.SqlParameter("@GDNGRIDSRNO", alParaval(I)))
                I = I + 1
    ...
    Public Function Update() As Integer
        ...
        Try
            ...
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@INVOICE_no", alParaval(I)))
                I = I + 1
            End With
    ...
    Public Function selectINVOICE(ByVal pono As Integer, ByVal Cmpid As Integer, ByVal LocationID As Integer, ByVal YearID As Integer) As DataTable
        ...
        Try
            ...
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@INVno", pono))
