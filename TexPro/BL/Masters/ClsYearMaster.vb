...
line1:
    ...
    Public Function saveexpense(ByVal EXPENSENAME As String, ByVal CMP As Integer, ByVal LOCATION As Integer, ByVal userid As Integer, ByVal YEAR As Integer, Optional ByVal whereclause As String = "", Optional ByVal REMARKS As String = "") As Integer

line1:
        Dim objclscommon As New ClsCommonMaster
        Dim dt As DataTable = objclscommon.search("EXP_id", "", "EXPENSEMASTER", whereclause & " AND EXP_NAME = '" & EXPENSENAME & "'")
        If (dt.Rows.Count) > 0 Then
            stateid = dt.Rows.Item(0).Item("state_id").ToString
        Else

            Dim strCmd As String = "SP_MASTER_EXPENSEMASTER_SAVE"
            Dim alpara As New ArrayList
            With alpara
                .Add(New SqlClient.SqlParameter("@EXP_name", UCase(EXPENSENAME)))
                .Add(New SqlClient.SqlParameter("@EXP_remark", REMARKS))
                .Add(New SqlClient.SqlParameter("@EXP_cmpid", CMP))
                .Add(New SqlClient.SqlParameter("@EXP_locationid", LOCATION))
                .Add(New SqlClient.SqlParameter("@EXP_userid", userid))
                .Add(New SqlClient.SqlParameter("@EXP_yearid", YEAR))
                .Add(New SqlClient.SqlParameter("@EXP_transfer", 0))
            End With
    ...
    Public Function save() As Integer
        ...
        Try
            ...
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@cmpmsmeno", alParaval(24)))
                ...
                .Add(New SqlClient.SqlParameter("@cmppassword", alParaval(36)))
                .Add(New SqlClient.SqlParameter("@cmpuserid", alParaval(37)))
                .Add(New SqlClient.SqlParameter("@cmptransfer", alParaval(38)))
            ...
            With alParameter
                .Add(New SqlClient.SqlParameter("@cmpname", alParaval(0)))
                .Add(New SqlClient.SqlParameter("@yearstart", alParaval(39)))
                .Add(New SqlClient.SqlParameter("@yearend", alParaval(40)))
                .Add(New SqlClient.SqlParameter("@userid", alParaval(37)))
                .Add(New SqlClient.SqlParameter("@locationid", "0"))
                .Add(New SqlClient.SqlParameter("@transfer", alParaval(38)))
                .Add(New SqlClient.SqlParameter("@cmpwithotsp", alParaval(42)))
            End With
            intResult = objDBOperation.executeNonQuery(strCommand, alParameter)
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            ...
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@TEMPCMPNAME", alParaval(42)))
