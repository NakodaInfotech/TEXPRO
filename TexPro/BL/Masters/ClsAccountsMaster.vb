    ...
    Public Function SAVE() As Integer
        ...
        Try
            ...
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@BALEINS", alParaval(I)))
                I += 1
                .Add(New SqlClient.SqlParameter("@TRANSRS", alParaval(I)))
                I += 1
                .Add(New SqlClient.SqlParameter("@SPPACKING", alParaval(I)))
                I += 1
                .Add(New SqlClient.SqlParameter("@FENTCHGS", alParaval(I)))
                I += 1
