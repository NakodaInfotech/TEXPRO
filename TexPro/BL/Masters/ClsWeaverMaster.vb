...
#Region "Function"
    ...
    Public Function save() As Integer
        ...
        Try
            ...
            'save WEAVERMaster
            Dim strCommand As String = "SP_MASTER_WEAVERMASTER_SAVE"
            Dim alParameter As New ArrayList
            With alParameter

                .Add(New SqlClient.SqlParameter("@WEAVERname", alParaval(0)))
    ...
    Public Function Update() As Integer
        ...
        Try
            ...
            'save WEAVERMaster
            Dim strCommand As String = "SP_MASTER_WEAVERMASTER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@yearid", alParaval(5)))
                .Add(New SqlClient.SqlParameter("@transfer", alParaval(6)))
                .Add(New SqlClient.SqlParameter("WEAVERid", alParaval(7)))
    ...
    Public Function DELETE() As DataTable
        Try
            Dim strCommand As String = "SP_MASTER_WEAVERMASTER_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@WEAVER", alParaval(0)))
