    ...
    Public Function updateuserdetails() As Integer
        ...
        Try
            ...
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@locationid", alParaval(10)))
                .Add(New SqlClient.SqlParameter("@userid", alParaval(11)))
                .Add(New SqlClient.SqlParameter("@yearid", alParaval(12)))
                .Add(New SqlClient.SqlParameter("@transfer", alParaval(13)))
                .Add(New SqlClient.SqlParameter("@UNAME", alParaval(19)))
