...
Public Class ClsSUPERVISIORMaster
...
#Region "Function"
    ...
    Public Function save() As Integer
        ...
        Try
            ...
            'save supervisiorMaster
            Dim strCommand As String = "SP_MASTER_supervisiorMASTER_SAVE"
            Dim alParameter As New ArrayList
            With alParameter

                .Add(New SqlClient.SqlParameter("@supervisiorname", alParaval(0)))
    ...
    Public Function Update() As Integer
        ...
        Try
            ...
            'save supervisiorMaster
            Dim strCommand As String = "SP_MASTER_supervisiorMASTER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@yearid", alParaval(5)))
                .Add(New SqlClient.SqlParameter("@transfer", alParaval(6)))
                .Add(New SqlClient.SqlParameter("supervisiorid", alParaval(7)))
