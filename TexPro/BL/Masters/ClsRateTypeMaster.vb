...
#Region "Function"
    ...
    Public Function save() As Integer
        ...
        Try
            ...
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@RATETYPEname", alParaval(0)))
    ...
    Public Function Update() As Integer
        ...
        Try
            ...
            'save RATETYPEMaster
            Dim strCommand As String = "SP_MASTER_RATETYPEMASTER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@yearid", alParaval(5)))
                .Add(New SqlClient.SqlParameter("@transfer", alParaval(6)))
                .Add(New SqlClient.SqlParameter("RATETYPEid", alParaval(7)))
