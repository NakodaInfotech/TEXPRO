...
#Region "Function"
    ...
    Public Function save() As Integer
        ...
        Try
            ...
            'save screenMaster
            Dim strCommand As String = "SP_MASTER_screenMASTER_SAVE"
            Dim alParameter As New ArrayList
            With alParameter

                .Add(New SqlClient.SqlParameter("@screenname", alParaval(0)))
    ...
    Public Function Update() As Integer
        ...
        Try
            ...
            'save screenMaster
            Dim strCommand As String = "SP_MASTER_screenMASTER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@yearid", alParaval(5)))
                .Add(New SqlClient.SqlParameter("@transfer", alParaval(6)))
                .Add(New SqlClient.SqlParameter("screenid", alParaval(7)))
