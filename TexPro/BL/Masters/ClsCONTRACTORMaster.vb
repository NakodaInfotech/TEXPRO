...
Public Class ClsCONTRACTORMaster
...
#Region "Function"
    ...
    Public Function save() As Integer
        ...
        Try
            ...
            'save CONTRACTORMaster
            Dim strCommand As String = "SP_MASTER_CONTRACTORMASTER_SAVE"
            Dim alParameter As New ArrayList
            With alParameter

                .Add(New SqlClient.SqlParameter("@CONTRACTORname", alParaval(0)))
    ...
    Public Function Update() As Integer
        ...
        Try
            ...
            'save CONTRACTORMaster
            Dim strCommand As String = "SP_MASTER_CONTRACTORMASTER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@yearid", alParaval(5)))
                .Add(New SqlClient.SqlParameter("@transfer", alParaval(6)))
                .Add(New SqlClient.SqlParameter("CONTRACTORid", alParaval(7)))
