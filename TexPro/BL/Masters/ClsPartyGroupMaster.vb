...
Public Class ClsPartyGroupMaster
...
#Region "Function"
    ...
    Public Function save() As Integer
        ...
        Try
            ...
            'save STAMPMaster
            Dim strCommand As String = "SP_MASTER_PARTYGROUPMASTER_SAVE"
    ...
    Public Function Update() As Integer
        ...
        Try
            ...
            'save STAMPMaster
            Dim strCommand As String = "SP_MASTER_PARTYGROUPMASTER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@yearid", alParaval(5)))
                .Add(New SqlClient.SqlParameter("@transfer", alParaval(6)))
                .Add(New SqlClient.SqlParameter("nameid", alParaval(7)))
