...
Public Class ClsPrintingTypeMaster
...
#Region "Function"
    ...
    Public Function save() As Integer
        ...
        Try
            ...
            'save PRINTINGTYPEMaster
            Dim strCommand As String = "SP_MASTER_PRINTINGTYPEMASTER_SAVE"
            Dim alParameter As New ArrayList
            With alParameter

                .Add(New SqlClient.SqlParameter("@PRINTINGTYPEname", alParaval(0)))
    ...
    Public Function Update() As Integer
        ...
        Try
            ...
            'save PRINTINGTYPEMaster
            Dim strCommand As String = "SP_MASTER_PRINTINGTYPEMASTER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@yearid", alParaval(5)))
                .Add(New SqlClient.SqlParameter("@transfer", alParaval(6)))
                .Add(New SqlClient.SqlParameter("PRINTINGTYPEid", alParaval(7)))
