...
#Region "Function"
    ...
    Public Function save() As Integer
        ...
        Try
            ...
            'save STAMPMaster
            Dim strCommand As String = "SP_MASTER_STAMPMASTER_SAVE"
            Dim alParameter As New ArrayList
            With alParameter

                .Add(New SqlClient.SqlParameter("@STAMPname", alParaval(0)))
    ...
    Public Function Update() As Integer
        ...
        Try
            ...
            'save STAMPMaster
            Dim strCommand As String = "SP_MASTER_STAMPMASTER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@yearid", alParaval(5)))
                .Add(New SqlClient.SqlParameter("@transfer", alParaval(6)))
                .Add(New SqlClient.SqlParameter("STAMPid", alParaval(7)))
