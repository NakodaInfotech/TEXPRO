...
#Region "Functions"
    ...
    Function ErrHandle(ByVal Errcode As Integer) As Boolean
        ...
        'THIS ERROR IS FOR CANNOT FIND TABLE 0
        'WHEN NOTHING IS RETRIEVED FROM THE QUERY
        'SPECIALLY FOR UPDATE AND DELETE QUERY (NONQUERY)
        If Errcode = 968456906 Then
            bln = True
        End If
        Return bln
    End Function
    ...
    End Function
    Public Function swaplotno() As Integer
        'ByRef modulename As String, ByVal srno As Integer, ByVal cmpid As Integer, ByVal Locationid As Integer, ByVal yearid As Integer
        Dim INTRESULT As Integer
        Try

            Dim strCommand As String = "SP_SWAP_LOTNO"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@OLD", alParaval(0)))
                .Add(New SqlClient.SqlParameter("@NEW", alParaval(1)))
    ...
    Public Function DELETE() As Integer
        ...
        Try
            ...
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@Locationid", alParaval(2)))
                .Add(New SqlClient.SqlParameter("@Yearid", alParaval(3)))
                .Add(New SqlClient.SqlParameter("@regname", alParaval(4)))
            End With
            INTRESULT = objDBOperation.executeNonQuery(strCommand, alParameter)
